...
ID: file-scripts-smartui-fast-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartui-fast-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartui-fast-agent-mjs --capability "kemampuan baru"
```
