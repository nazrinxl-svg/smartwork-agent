...
ID: file-scripts-smartagent-builder-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartagent-builder-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartagent-builder-mjs --capability "kemampuan baru"
```
