...
ID: file-scripts-smartdev-brain-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartdev-brain-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartdev-brain-mjs --capability "kemampuan baru"
```
