# Agent Army Report Support

ID: agent-army-report-support
...
## Run
```powershell
safarmy run --agent agent-army-report-support "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent agent-army-report-support --capability "kemampuan baru"
```
