...
ID: file-scripts-smartsupabase-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartsupabase-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartsupabase-agent-mjs --capability "kemampuan baru"
```
