...
ID: file-scripts-smartauth-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartauth-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartauth-agent-mjs --capability "kemampuan baru"
```
