...
ID: command-npm-run-smartui-shot
...
## Run
```powershell
safarmy run --agent command-npm-run-smartui-shot "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-smartui-shot --capability "kemampuan baru"
```
