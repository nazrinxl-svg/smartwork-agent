...
ID: file-scripts-smartui-designer-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartui-designer-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartui-designer-mjs --capability "kemampuan baru"
```
