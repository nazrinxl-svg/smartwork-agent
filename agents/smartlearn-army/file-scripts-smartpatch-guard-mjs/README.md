...
ID: file-scripts-smartpatch-guard-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartpatch-guard-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartpatch-guard-mjs --capability "kemampuan baru"
```
