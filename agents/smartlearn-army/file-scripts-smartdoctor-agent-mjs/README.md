...
ID: file-scripts-smartdoctor-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartdoctor-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartdoctor-agent-mjs --capability "kemampuan baru"
```
