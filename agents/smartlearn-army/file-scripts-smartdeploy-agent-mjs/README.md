...
ID: file-scripts-smartdeploy-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartdeploy-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartdeploy-agent-mjs --capability "kemampuan baru"
```
