...
ID: file-scripts-smartui-screenshot-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartui-screenshot-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartui-screenshot-mjs --capability "kemampuan baru"
```
