...
ID: command-npm-run-agent-trainer
...
## Run
```powershell
safarmy run --agent command-npm-run-agent-trainer "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-agent-trainer --capability "kemampuan baru"
```
