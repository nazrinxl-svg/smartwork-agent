...
ID: file-scripts-smartmission-runner-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartmission-runner-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartmission-runner-agent-mjs --capability "kemampuan baru"
```
