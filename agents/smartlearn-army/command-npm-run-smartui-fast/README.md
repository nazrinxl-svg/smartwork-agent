...
ID: command-npm-run-smartui-fast
...
## Run
```powershell
safarmy run --agent command-npm-run-smartui-fast "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-smartui-fast --capability "kemampuan baru"
```
