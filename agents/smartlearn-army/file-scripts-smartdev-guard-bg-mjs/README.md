...
ID: file-scripts-smartdev-guard-bg-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartdev-guard-bg-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartdev-guard-bg-mjs --capability "kemampuan baru"
```
