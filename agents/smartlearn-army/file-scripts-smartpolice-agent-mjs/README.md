...
ID: file-scripts-smartpolice-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartpolice-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartpolice-agent-mjs --capability "kemampuan baru"
```
