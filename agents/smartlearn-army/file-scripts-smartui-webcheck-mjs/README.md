...
ID: file-scripts-smartui-webcheck-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartui-webcheck-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartui-webcheck-mjs --capability "kemampuan baru"
```
