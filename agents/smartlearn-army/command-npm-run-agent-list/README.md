...
## Run
```powershell
safarmy run --agent command-npm-run-agent-list "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-agent-list --capability "kemampuan baru"
```
