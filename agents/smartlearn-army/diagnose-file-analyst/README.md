# Diagnose File Analyst

ID: diagnose-file-analyst
...
## Run
```powershell
safarmy run --agent diagnose-file-analyst "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent diagnose-file-analyst --capability "kemampuan baru"
```
