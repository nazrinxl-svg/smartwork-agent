...
ID: command-npm-run-smartui-register-judge
...
## Run
```powershell
safarmy run --agent command-npm-run-smartui-register-judge "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-smartui-register-judge --capability "kemampuan baru"
```
