...
ID: file-scripts-smarttrainer-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smarttrainer-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smarttrainer-agent-mjs --capability "kemampuan baru"
```
