...
ID: file-scripts-smartpaste-auto-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartpaste-auto-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartpaste-auto-agent-mjs --capability "kemampuan baru"
```
