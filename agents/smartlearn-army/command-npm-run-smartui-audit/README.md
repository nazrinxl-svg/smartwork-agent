...
ID: command-npm-run-smartui-audit
...
## Run
```powershell
safarmy run --agent command-npm-run-smartui-audit "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-smartui-audit --capability "kemampuan baru"
```
