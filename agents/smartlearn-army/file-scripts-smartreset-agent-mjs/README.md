...
ID: file-scripts-smartreset-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartreset-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartreset-agent-mjs --capability "kemampuan baru"
```
