# Agent Builder Ranger

ID: agent-builder-ranger
...
## Run
```powershell
safarmy run --agent agent-builder-ranger "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent agent-builder-ranger --capability "kemampuan baru"
```
