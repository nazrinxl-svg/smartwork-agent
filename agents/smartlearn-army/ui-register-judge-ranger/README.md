# Ui Register Judge Ranger

ID: ui-register-judge-ranger
...
## Run
```powershell
safarmy run --agent ui-register-judge-ranger "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent ui-register-judge-ranger --capability "kemampuan baru"
```
