...
ID: command-npm-run-mission-guard
...
## Run
```powershell
safarmy run --agent command-npm-run-mission-guard "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-mission-guard --capability "kemampuan baru"
```
