...
ID: file-scripts-smartvercel-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartvercel-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartvercel-agent-mjs --capability "kemampuan baru"
```
