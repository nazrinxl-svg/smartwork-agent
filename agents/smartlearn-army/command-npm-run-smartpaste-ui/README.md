...
ID: command-npm-run-smartpaste-ui
...
## Run
```powershell
safarmy run --agent command-npm-run-smartpaste-ui "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-smartpaste-ui --capability "kemampuan baru"
```
