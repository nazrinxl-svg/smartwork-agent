...
ID: file-scripts-smartpaste-ui-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartpaste-ui-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartpaste-ui-agent-mjs --capability "kemampuan baru"
```
