# Patch Guard Guardian

ID: patch-guard-guardian
...
## Run
```powershell
safarmy run --agent patch-guard-guardian "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent patch-guard-guardian --capability "kemampuan baru"
```
