...
ID: file-scripts-smartagent-army-report-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartagent-army-report-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartagent-army-report-mjs --capability "kemampuan baru"
```
