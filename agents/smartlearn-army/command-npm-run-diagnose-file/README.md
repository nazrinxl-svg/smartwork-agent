...
ID: command-npm-run-diagnose-file
...
## Run
```powershell
safarmy run --agent command-npm-run-diagnose-file "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-diagnose-file --capability "kemampuan baru"
```
