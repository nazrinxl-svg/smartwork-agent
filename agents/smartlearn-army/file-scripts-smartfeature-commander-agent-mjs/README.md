...
ID: file-scripts-smartfeature-commander-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartfeature-commander-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartfeature-commander-agent-mjs --capability "kemampuan baru"
```
