...
## Run
```powershell
safarmy run --agent command-npm-run-agent-make "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-agent-make --capability "kemampuan baru"
```
