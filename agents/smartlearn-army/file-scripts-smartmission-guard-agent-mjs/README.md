...
ID: file-scripts-smartmission-guard-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartmission-guard-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartmission-guard-agent-mjs --capability "kemampuan baru"
```
