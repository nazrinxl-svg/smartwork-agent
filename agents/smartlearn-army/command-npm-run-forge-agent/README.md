...
ID: command-npm-run-forge-agent
...
## Run
```powershell
safarmy run --agent command-npm-run-forge-agent "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-forge-agent --capability "kemampuan baru"
```
