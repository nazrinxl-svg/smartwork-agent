...
ID: file-scripts-smartui-audit-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartui-audit-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartui-audit-mjs --capability "kemampuan baru"
```
