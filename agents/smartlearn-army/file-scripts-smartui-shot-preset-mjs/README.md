...
ID: file-scripts-smartui-shot-preset-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartui-shot-preset-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartui-shot-preset-mjs --capability "kemampuan baru"
```
