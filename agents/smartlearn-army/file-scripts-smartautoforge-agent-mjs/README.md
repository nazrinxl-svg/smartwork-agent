...
ID: file-scripts-smartautoforge-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartautoforge-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartautoforge-agent-mjs --capability "kemampuan baru"
```
