# Ui Shot Preset Gatekeeper

ID: ui-shot-preset-gatekeeper
...
## Run
```powershell
safarmy run --agent ui-shot-preset-gatekeeper "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent ui-shot-preset-gatekeeper --capability "kemampuan baru"
```
