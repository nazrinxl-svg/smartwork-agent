...
## Run
```powershell
safarmy run --agent guard-security-guardian "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent guard-security-guardian --capability "kemampuan baru"
```
