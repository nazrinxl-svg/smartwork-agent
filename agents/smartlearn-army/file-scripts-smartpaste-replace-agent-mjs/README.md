...
ID: file-scripts-smartpaste-replace-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartpaste-replace-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartpaste-replace-agent-mjs --capability "kemampuan baru"
```
