...
ID: file-scripts-smartforge-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartforge-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartforge-agent-mjs --capability "kemampuan baru"
```
