...
ID: file-scripts-smartui-control-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartui-control-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartui-control-mjs --capability "kemampuan baru"
```
