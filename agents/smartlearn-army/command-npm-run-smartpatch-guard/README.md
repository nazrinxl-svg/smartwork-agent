...
ID: command-npm-run-smartpatch-guard
...
## Run
```powershell
safarmy run --agent command-npm-run-smartpatch-guard "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-smartpatch-guard --capability "kemampuan baru"
```
