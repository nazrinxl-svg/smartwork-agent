...
ID: command-npm-run-smartui-webcheck
...
## Run
```powershell
safarmy run --agent command-npm-run-smartui-webcheck "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-smartui-webcheck --capability "kemampuan baru"
```
