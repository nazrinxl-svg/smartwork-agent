...
ID: file-scripts-smartclip-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartclip-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartclip-agent-mjs --capability "kemampuan baru"
```
