...
## Run
```powershell
safarmy run --agent command-npm-run-agent-army "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent command-npm-run-agent-army --capability "kemampuan baru"
```
