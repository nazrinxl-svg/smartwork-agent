...
ID: file-scripts-smartroute-agent-mjs
...
## Run
```powershell
safarmy run --agent file-scripts-smartroute-agent-mjs "tugas agent" --clip
```

## Evolve
```powershell
safarmy evolve --agent file-scripts-smartroute-agent-mjs --capability "kemampuan baru"
```
