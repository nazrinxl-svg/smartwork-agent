...
const reportPath = path.join(reportsDir, `${stamp}-siaga-fill-detail-6-30-juni-2026-skip-minggu.json`);
...
const TARGET_DAYS = [
  ...
  { tanggal: "7",  date: "2026-06-07", hari: "Minggu", skip: true },
  { tanggal: "8",  date: "2026-06-08", hari: "Senin",  pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "9",  date: "2026-06-09", hari: "Selasa", pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "10", date: "2026-06-10", hari: "Rabu",   pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "11", date: "2026-06-11", hari: "Kamis",  pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "12", date: "2026-06-12", hari: "Jum'at", pulangStart: "11:30", pulangEnd: "11:35" },
  { tanggal: "13", date: "2026-06-13", hari: "Sabtu",  pulangStart: "15:15", pulangEnd: "15:30" },
  { tanggal: "14", date: "2026-06-14", hari: "Minggu", skip: true },
  { tanggal: "15", date: "2026-06-15", hari: "Senin",  pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "16", date: "2026-06-16", hari: "Selasa", pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "17", date: "2026-06-17", hari: "Rabu",   pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "18", date: "2026-06-18", hari: "Kamis",  pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "19", date: "2026-06-19", hari: "Jum'at", pulangStart: "11:30", pulangEnd: "11:35" },
  { tanggal: "20", date: "2026-06-20", hari: "Sabtu",  pulangStart: "15:15", pulangEnd: "15:30" },
  { tanggal: "21", date: "2026-06-21", hari: "Minggu", skip: true },
  { tanggal: "22", date: "2026-06-22", hari: "Senin",  pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "23", date: "2026-06-23", hari: "Selasa", pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "24", date: "2026-06-24", hari: "Rabu",   pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "25", date: "2026-06-25", hari: "Kamis",  pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "26", date: "2026-06-26", hari: "Jum'at", pulangStart: "11:30", pulangEnd: "11:35" },
  { tanggal: "27", date: "2026-06-27", hari: "Sabtu",  pulangStart: "15:15", pulangEnd: "15:30" },
  { tanggal: "28", date: "2026-06-28", hari: "Minggu", skip: true },
  { tanggal: "29", date: "2026-06-29", hari: "Senin",  pulangStart: "14:15", pulangEnd: "14:30" },
  { tanggal: "30", date: "2026-06-30", hari: "Selasa", pulangStart: "14:15", pulangEnd: "14:30" }
];
...
async function main() {
  console.log("SMARTWORK_AGENT=FILL_DETAIL_ABSENSI_6_30_JUNI_2026_SKIP_MINGGU");
  console.log("RULE=SAVE_ALLOWED_SKIP_MINGGU_NO_ZOOM_NO_VIEWPORT");
  ...
  screenshots.push(await screenshot(page, "00-before-fill-6-30"));

  for (const target of TARGET_DAYS) {
    console.log(`\n=== PROCESS ${target.date} ${target.hari} ===`);

    if (target.skip || /Minggu/i.test(target.hari)) {
      console.log(`SKIP_MINGGU=${target.date}`);
      results.push({
        target,
        skipped: true,
        reason: "Minggu tidak diisi",
        ok: true
      });
      continue;
    }
  ...
  screenshots.push(await screenshot(page, "99-final-fill-6-30"));
  ...
  const finalState = await page.evaluate(() => {
    ...
    return {
      url: location.href,
      bodyPreview: clean(document.body.innerText || "").slice(0, 3200)
    };
  });
  ...
  const report = {
    agent: "FILL_DETAIL_ABSENSI_6_30_JUNI_2026_SKIP_MINGGU",
    rule: "SAVE_ALLOWED_SKIP_MINGGU_NO_ZOOM_NO_VIEWPORT",
    startUrl,
    targets: TARGET_DAYS,
    results,
    finalState,
  ...
  if (!ok) {
    ...
    throw new Error("STOP: Tidak semua tanggal 6-30 berhasil diisi/disimpan.");
  }

  console.log("SMARTWORK_FILL_DETAIL_6_30_JUNI_2026_SKIP_MINGGU=OK");
}

main().catch(error => {
  console.error("SMARTWORK_FILL_DETAIL_6_30_JUNI_2026_SKIP_MINGGU=FAILED");
